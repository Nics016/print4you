...
return [
    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'suffix' => '/',
            'rules' => [
                'constructor/get-products' => 'constructor/get-products',           
                'constructor/add-to-cart' => 'constructor/add-to-cart',           
                'constructor/<alias:[\d\w_-]+>' => 'constructor/index',
                'constructor-category/<alias:[\d\w_-]+>' => 'uslugi/constructor-category',
